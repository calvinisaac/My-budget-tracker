...
import { Plus, ArrowUpRight, ArrowDownLeft, Trash2, DollarSign, List, LayoutDashboard, Settings, Search, Download, Calendar, Repeat, Sparkles, Bot, Target, Banknote, ShieldCheck, LogOut, ChevronLeft, ChevronRight, Award, RefreshCw, TrendingUp, MoreHorizontal, Sun, Moon, Wind } from 'lucide-react';
        ...
        >
            ...
            <div className="col-span-12 lg:col-span-8 space-y-6">
                <motion.div variants={itemVariants} className="grid grid-cols-1 md:grid-cols-3 gap-6">
                    ...
                    <SummaryCard title="This Month's Balance" amount={balance} icon={DollarSign} color={balance >= 0 ? "text-sky-400" : "text-orange-400"} bgColor={balance >= 0 ? "bg-sky-500/10" : "bg-orange-500/10"} />
                </motion.div>
    ...
    return (
        <div className="space-y-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                <SummaryCard title="Current Balance" amount={currentBalance} icon={DollarSign} color="text-sky-400" bgColor="bg-sky-500/10" />
